...
class MELBenchVicunaCompleteExtractor(Extractor):
    ...
    def build_message(self,mention,attribute_key,candidate_attribute_value_list,review,prefix):
        ...
        example=prefix +"Review: Hieronymus David Gaubius (24 February 1705 – 29 November 1780) was a German physician and chemist." + ".\n Birth date: 1705-02-24.\n"
